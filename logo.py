...
==============================================={nc}''')
  ...
  def not_ins(self):
    self.tool_header()
    print (f'''
{cyan}  [ + ]  {red}We can't install Tw Team.
...
{red} If you are installing this tool.
 that means you are agree with all terms.''')
  ...
  def ins_sc(self):
    self.tool_header()
    print (f'''
{yellow}    [ + ] {green}Tw Team installed successfully.
{yellow}    [ + ] {green}To run Tw Team,
{yellow}    [ + ] {green}Type Tw Team in your terminal.''')
    self.tool_footer()
  ...
  def update(self):
    self.tool_header()
    print (f'''
{yellow}  [ 1 ] {green}Update your Tw Team.
{yellow}  [ 0 ] {green}For Back.{nc}''')
  ...
  def updated(self):
    self.tool_header()
    print (f'''
{yellow}      [ + ] {green}Tw Team Updated Successfully.
...
{cyan}  [ + ]  {red}Please try again after some time.{nc}''')
  ...
  def update_error(self):
    self.tool_header()
    print (f'''
{red}  [ + ]  {red}We can't Update Tw Team.\033[1;m
{red}  [ + ]  {red}Please try again after some time.{nc}''')
  ...
  def about(self,total):
    self.tool_header()
    print (f'''
{yellow}       [+] Tool Name :- {green}Tw Team
...
{yellow}|  00) Back                                   |
 \033[01;36m============================================={nc}""")
  ...
  def updating(self):
    print (f"""{yellow} =============================================
{green}|______________ Updating Tw Team ______________|
 {yellow}============================================={nc}""")
...
{yellow}  [ x ] {green}For Exit.''')
  ...
  def exit(self):
    self.tool_header()
    print (f'''
{yellow}         [ + ] {green}Thanks for using Tw Team
