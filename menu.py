...
class main:
  def install_tools(self):
    while True:
      ...
      print(f"")
      logo.back()
      cmd=input(f"{blue}Tw Team{nc}@{blue}space {yellow}$ {nc}")
        ...
        try:
          if int(cmd) in range(1,int(total)+1):
            while True:
              ...
              print(f"")
              logo.back()
              tcmd=input(f"{blue}Tw Team{nc}@{blue}space {yellow}$ {nc}")
    ...
    while True:
      ...
      if cmd=="1":
        ...
        if system.connection():
          ...
          logo.updating()
          if system.sudo != None:
            if os.path.exists(system.home+"/Tw Team"):
              pass
            else:
              os.system(system.sudo+" git clone https://github.com/rajkumardusad/Tw Team.git "+system.home+"/Tw Team")
            if os.path.exists(system.home+"/Tw Team/install.aex"):
              os.system("cd "+system.home+"/Tw Team && "+system.sudo+" sh install.aex")
            ...
            if os.path.exists(system.home+"/Tw Team"):
              ...
              os.system("git clone https://github.com/rajkumardusad/Tw Team.git "+system.home+"/Tw Team")
            if os.path.exists(system.home+"/Tw Team/install.aex"):
              os.system("cd "+system.home+"/Tw Team && sh install.aex")
              if os.path.exists(system.bin+"/Tw Team") and os.path.exists(system.conf_dir+"/Tw Team"):
                os.system("clear")
                logo.updated()
                cmd=input(f"{blue}Tw Team{nc}@{blue}space {yellow}$ {nc}")
  ...
  def menu(self):
    while True:
      ...
      if cmd == "1":
        ...
        logo.exit()
        break
      elif cmd=="rm -t" or cmd=="rm -T" or cmd=="uninstall tool-x" or cmd=="unistall Tw Team":
        system=sys()
        if system.sudo:
          os.system(system.sudo+" rm -rf "+system.bin+"/Tw Team")
          os.system(system.sudo+" rm -rf "+system.bin+"/toolx")
          os.system(system.sudo+" rm -rf "+system.conf_dir+"/Tw Team")
        else:
          os.system("rm -rf "+system.bin+"/Tw Team")
          os.system("rm -rf "+system.bin+"/toolx")
          os.system("rm -rf "+system.conf_dir+"/Tw Team")
        os.system("clear")
        logo.exit()
        break
      else:
...
class tools:
  ...
  def __init__(self):
    system=sys()
    with open(system.conf_dir+"/Tw Team/core/data.json") as data_file:
      self.data=json.load(data_file)
    with open(system.conf_dir+"/Tw Team/core/cat.json") as cat_file:
